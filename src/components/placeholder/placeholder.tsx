...
export const PlaceholderList = (props) => (
  <ContentLoader
    ...
    {...props}
  >
    <rect x="2" y="2" rx="0" ry="0" width="85" height="85" />
    <rect x="90" y="2" rx="0" ry="0" width="300" height="60" />
    <rect x="90" y="65" rx="0" ry="0" width="300" height="20" />
    <rect x="400" y="2" rx="0" ry="0" width="210" height="20" />
    <rect x="400" y="25" rx="0" ry="0" width="210" height="20" />
    <rect x="620" y="2" rx="0" ry="0" width="210" height="20" />
    <rect x="620" y="25" rx="0" ry="0" width="210" height="20" />
    <rect x="0" y="98" rx="0" ry="0" width="100%" height="2" />
  </ContentLoader>
);
